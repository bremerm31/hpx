...
namespace hpx { namespace util { namespace logging {
    ...
    template<class write_msg> struct forward_to_logger ;
    ...
    namespace detail {
        ...
        */
        struct default_cache_keeper {
            typedef detail::cache_before_init<
                optimize::cache_string_one_str > cache_type;
    ...
    namespace detail {
        template<class write_msg, class dummy = void > struct common_base_holder {
            typedef logger<default_> common_base_type;
        ...
        protected:
            ...
            // without having to know the full type of the log.
            forward_to_logger<write_msg> m_base;
        };

        // specialize - when write_msg is default, our common base is ourselves
        template<class dummy> struct common_base_holder<default_, dummy> {
            typedef logger<default_> subclass_type;
    ...
    */
    ...
    struct logger_base
            : detail::default_cache_keeper,
              detail::common_base_holder<write_msg> {
        typedef detail::default_cache_keeper cache_base;
        using cache_base::cache;

        typedef logger<write_msg> subclass_type;
        typedef detail::common_base_holder<write_msg> common_base_type;
